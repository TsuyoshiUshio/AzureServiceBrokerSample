...
function curryPromise(f, timeout = 60000, maxRetries = 0, retryTimer, retryOn404) {
    return (...args) => {
        // return Promise for result or error
        var started = false, done;
        var retries = maxRetries, timeoutTimer;
...
exports.curryPromise = curryPromise;
/** Return a promise that resolves after a given timeout */
function sleepAsync(ms, value = undefined) {
