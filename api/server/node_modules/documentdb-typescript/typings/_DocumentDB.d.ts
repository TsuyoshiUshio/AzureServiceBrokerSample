...
export declare type Callback<T extends Resource> = (error: ClientError, resource: T, responseHeaders: {}) => void;
...
export declare type WriteSprocResource = Partial<SprocResource> & {
    /** The unique name of this stored procedure */
    id: string;
